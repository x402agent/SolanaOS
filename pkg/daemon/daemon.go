...
func (d *Daemon) conciseHelpBody(isTelegram bool) string {
	...
	b.WriteString("/sniper — Pump.fun Mayhem Sniper bot (start/stop/logs/config)\n")
	b.WriteString("/aibot — Pump.fun AI Trading Bot (start/stop/logs/config)\n")
	b.WriteString("/bots — Status of both pump.fun bots\n")
...
func (d *Daemon) fullHelpResponse(isTelegram bool) string {
	...
	b.WriteString("/bots — Status overview of both pump.fun bots\n")
