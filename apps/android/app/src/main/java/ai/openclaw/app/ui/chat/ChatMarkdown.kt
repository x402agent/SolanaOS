...
private fun RenderParagraph(
  ...
  Text(
    text = annotated,
    style = mobileBody.copy(fontSize = 16.sp, lineHeight = 24.sp),
    color = textColor,
  )
}
      ...
      Row(
        ...
        for (index in 0 until maxCols) {
          ...
          Text(
            ...
            style =
              if (row.isHeader) {
                mobileCaption1.copy(fontWeight = FontWeight.SemiBold)
              } else {
                mobileBody.copy(fontSize = 14.sp, lineHeight = 21.sp)
              },
            color = textColor,
            modifier = Modifier
...
private fun headingStyle(level: Int): TextStyle {
  return when (level.coerceIn(1, 6)) {
    1 -> mobileBody.copy(fontSize = 24.sp, lineHeight = 30.sp, fontWeight = FontWeight.Bold)
    2 -> mobileBody.copy(fontSize = 21.sp, lineHeight = 28.sp, fontWeight = FontWeight.Bold)
    3 -> mobileBody.copy(fontSize = 18.sp, lineHeight = 25.sp, fontWeight = FontWeight.SemiBold)
    4 -> mobileBody.copy(fontSize = 16.sp, lineHeight = 23.sp, fontWeight = FontWeight.SemiBold)
    else -> mobileBody.copy(fontWeight = FontWeight.SemiBold)
  }
}
