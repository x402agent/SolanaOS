...
class OpenClawProtocolConstantsTest {
  ...
  @Test
  fun wireValueParsingUsesCanonicalStrings() {
    assertEquals(OpenClawCanvasA2UICommand.Push, OpenClawCanvasA2UICommand.fromRaw("canvas.a2ui.push"))
    assertEquals(OpenClawCapability.Canvas, OpenClawCapability.fromRaw("canvas"))
    assertEquals(OpenClawSystemCommand.Notify, OpenClawSystemCommand.fromRaw("system.notify"))
    assertNull(OpenClawCanvasCommand.fromRaw("canvas.push"))
  }

  @Test
  fun wireValueCatalogsContainPublishedValues() {
    assertTrue(OpenClawCanvasCommand.allRawValues.contains("canvas.present"))
    assertTrue(OpenClawCanvasA2UICommand.allRawValues.contains("canvas.a2ui.reset"))
    assertTrue(OpenClawCapability.allRawValues.contains("camera"))
  }
}
