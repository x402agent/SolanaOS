...
class BonjourEscapesTest {
  ...
  @Test
  fun decodeLeavesIncompleteOrInvalidEscapesLiteral() {
    assertEquals("abc\\03", BonjourEscapes.decode("abc\\03"))
    assertEquals("abc\\999", BonjourEscapes.decode("abc\\999"))
    assertEquals("abc\\x20", BonjourEscapes.decode("abc\\x20"))
  }
}
