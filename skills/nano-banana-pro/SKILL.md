...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.nanosolana/nanosolana.json`
...
- The script prints a `MEDIA:` line for NanoSolana to auto-attach on supported chat providers.
