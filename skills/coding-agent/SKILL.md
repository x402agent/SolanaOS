...
```text
GET  /api/gateway/coding/sessions
POST /api/gateway/coding/sessions
GET  /api/gateway/coding/sessions/:id
POST /api/gateway/coding/sessions/:id/prompt
GET  /api/gateway/coding/sessions/:id/log
POST /api/gateway/coding/sessions/:id/kill
...
```json
{
  ...
  "prompt": "Review the auth flow and fix the failing tests",
  "label": "auth-fix",
...
```text
create a GitHub repo for a private Next.js SaaS starter
start Claude Code in /Users/8bit/Projects/myapp and scaffold an auth API
continue and add Stripe billing
show my coding log
