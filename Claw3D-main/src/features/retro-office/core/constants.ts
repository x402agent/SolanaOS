...
export const STORAGE_KEY = "solanaos-office-furniture-v9";
export const ATM_MIGRATION_KEY = "solanaos-office-atm-migration-v1";
export const SERVER_ROOM_MIGRATION_KEY =
  "solanaos-office-server-room-migration-v3";
export const GYM_ROOM_MIGRATION_KEY = "solanaos-office-gym-room-migration-v3";
export const QA_LAB_MIGRATION_KEY = "solanaos-office-qa-lab-migration-v3";
export const PHONE_BOOTH_MIGRATION_KEY = "solanaos-office-phone-booth-migration-v1";
export const SMS_BOOTH_MIGRATION_KEY = "solanaos-office-sms-booth-migration-v1";
