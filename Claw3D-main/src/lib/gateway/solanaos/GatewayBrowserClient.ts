// Adapted from `solanaos/solanaos` `ui/src/ui/gateway.ts`.
// Source license: MIT. Last verified against SolanaOS 2026.2.12
...
const GATEWAY_CLIENT_NAMES = {
  CONTROL_UI: "solanaos-control-ui",
} as const;
...
const DEVICE_AUTH_STORAGE_KEY = "solanaos.device.auth.v1";
...
const DEVICE_IDENTITY_STORAGE_KEY = "solanaos-device-identity-v1";
