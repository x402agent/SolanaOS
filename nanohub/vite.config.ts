...
const reactDomServerNodePath = require.resolve('react-dom/server.node')
const reactDomStaticNodePath = require.resolve('react-dom/static.node')
...
const config = defineConfig({
  resolve: {
    ...
    alias: {
      ...
      'react-dom/server': reactDomServerNodePath,
      'react-dom/static': reactDomStaticNodePath,
    },
  },
  optimizeDeps: {
